...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand mt-2 mt-lg-0" href="gestor.php">
                <img
                    src="../../content/images/logo/outdoors.png"
                    height="25"
                    loading="lazy"
                    id="logo"
            ...
            <div class="collapse navbar-collapse" id="textoNavbar">
                Gestor
                <div class="dropdown " id="login" style="margin-left: 72%">
                    <div class="d-flex align-items-right text-right">
                     <button type="button" class="btn btn-link px-3 me-2" style="color:black">
                        ...
                        <button type="button" class="btn btn-primary me-3" id="btn-login">
                            ...
                            <a href="form-outdoor.php" style="color:white"> Cadastrar Outdoor </a>
                        </button>
                    </div>
                </div>
            </div>
