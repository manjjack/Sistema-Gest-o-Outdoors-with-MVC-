...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" style="height: 75vh">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 h-75 images" src="../content/images/images-outdoors/outdoor-Angola.jpg" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
...
<div id="" class="row">
  <div class="col-md-4">
    <div class="service_box text-center">
      ...
      <p class="service_description">Maximize o impacto da sua mensagem com outdoors impressionantes! Nossos espaços publicitários ao ar livre oferecem ampla visibilidade para promover sua marca, produtos ou eventos.</p>
  ...
  <div class="col-md-4">
    <div class="service_box text-center">
      ...
      <p class="service_description">Descubra nossas opções de preços flexíveis e competitivos para anúncios em outdoors. Oferecemos planos personalizados que se adaptam às necessidades do seu negócio, seja para campanhas de curto ou longo prazo.</p>
      <div class="more_button"><a href="info.php" class="btn btn-primary">Ler Mais</a></div>
    </div>
  </div>
  ...
  <div class="col-md-4">
    <div class="service_box text-center">
      ...
      <p class="service_description">O marketing em outdoors é a combinação perfeita entre o poder do outdoor e as estratégias de marketing modernas. Aproveite o poder visual dos outdoors para promover sua marca ançar produtos, destacar promoções especiais</p>
      <div class="more_button"><a href="info.php" class="btn btn-primary">Ler Mais</a></div>
    </div>
  </div>
</div>
